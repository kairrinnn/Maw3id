...
### Phase 4.5: LLM Responses (INSERTED)
**Goal**: Every bot reply is generated by Gemini Flash in context, replacing all hardcoded FSM strings — responses feel human, warm, and adapted to Moroccan salon culture
**Depends on**: Phase 4
**Requirements**: BOT-04
**Success Criteria** (what must be TRUE):
  1. Sending "je veux un rendez-vous" produces a warm, natural French reply (not "Quel service souhaitez-vous?")
...
**Plans:** 2/2 plans complete
Plans:
- [x] 05-01-PLAN.md — sendTemplateMessage implementation, /api/templates/submit route, seed 3 standard templates per tenant (TPL-01) (completed 2026-05-04)
- [x] 05-02-PLAN.md — /api/reminders/send route with optimistic-lock idempotency, pg_cron 5-min schedule (TPL-02) (completed 2026-05-05)
...
**Execution Order:**
Phases execute in numeric order: 1 -> 2 -> 3 -> 4 -> 4.5 -> 5 -> 6 -> 7 -> 8
...
| 6. Dashboard Admin | 2/4 | In Progress|  |
